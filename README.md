...
* [`Makefile`](Makefile) — команды для сборки
    (скачает [`mitigator_bpf.h`](https://docs.mitigator.ru/v21.04/kb/bpf/mitigator_bpf.h)).
* [Документация](https://docs.mitigator.ru/v21.04/kb/bpf)
...
через параметры. Комментариями `TODO` отмечены места для модификаций, чтобы
сделать программу для обработки других опций TCP или для изменения логики.
